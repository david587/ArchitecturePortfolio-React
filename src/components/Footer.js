...
export default function Footer() {
  return (
    <>
    <div className="spacer4 layer4dark grid grid-cols-1 md:grid-cols-4 gap-2  text-left text-white">
        <div className='mt-[60px] border-r-2 border-white h-[180px] ml-20 pr-10'>
          <p className='font-medium mb-4'>About Us</p>
        ...
        <div className='mt-[60px] border-r-2 border-white h-[180px] ml-4'>
          ...
          <ul className='text-stone-300 inline-block'>
            ...
            <li className='hover:underline'>  <img src={Phone} alt="phone" className='inline-block w-6'/> Budapest 6. Area</li>
            <li className='hover:underline'>FAQ</li>
          </ul>
        </div>
    </div>
