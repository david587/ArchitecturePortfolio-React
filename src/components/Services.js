  ...
  return (
    ...
    <div className=' grid md:flex md:flex-row justify-between my-5'>
      <div className='flex-1'>
        <h1 className='text-4xl font-semibold lg:text-center'>My Services to have a better Home</h1>
      </div>
    </div>
    {/* grid */}
    <div>
      ...
      <div className='bg-stone-100 p-10  border-x-4 border-solid border-x-yellow'>
        ...
        <div className='bg-stone-100 p-10  border-y-4 border-solid border-y-yellow'>
